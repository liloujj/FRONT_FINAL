...
export default function ScanResult() {
      ...
      setTimeout(
        () => {
          ...
          const mockResult = {
            ...
            status: "Completed",
            finding:
              Math.random() > 0.7 ? "Possible abnormality detected in lower region" : "No abnormalities detected",
  ...
  const faqItems = [
    ...
    {
      question: t("Why do regular patients have to wait 24-48 hours for results?"),
      answer: t(
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
              <Box
                sx={{
                  ...
                  boxShadow: "0 10px 20px rgba(0, 0, 0, 0.1), inset 0 0 0 1px rgba(255, 255, 255, 0.05)",
                  mr: 3,
                  position: "relative",
                  overflow: "hidden",
                  "&::before": {
            ...
            <Card
              sx={{
                ...
                "&::before": {
                  ...
                  borderRadius: "25px",
                  padding: "1px",
                  background: "linear-gradient(130deg, #f59e0b, transparent, #f59e0b)",
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 3, zIndex: 1 }}>
                  <Box
                    sx={{
                      ...
                      height: 70,
                      borderRadius: "20px",
                      background: "linear-gradient(130deg, rgba(245, 158, 11, 0.2), rgba(245, 158, 11, 0.1))",
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      boxShadow: "0 10px 20px rgba(0, 0, 0, 0.1), inset 0 0 0 1px rgba(245, 158, 11, 0.2)",
                      position: "relative",
                      "&::after": {
                        content: '""',
                        position: "absolute",
                        ...
                        borderRadius: "23px",
                        padding: "3px",
                        background: "linear-gradient(130deg, rgba(245, 158, 11, 0.5), transparent)",
                        WebkitMask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                        WebkitMaskComposite: "xor",
                        maskComposite: "exclude",
                        opacity: 0.5,
          ...
          <Card
            sx={{
              ...
              "&::before": {
                ...
                borderRadius: "25px",
                padding: "1px",
                background: "linear-gradient(130deg, #ec4899, transparent, #d946ef)",
                WebkitMask: "linear-gradient(#fff 0 0) content-box, linear-gradient(#fff 0 0)",
                WebkitMaskComposite: "xor",
                maskComposite: "exclude",
                pointerEvents: "none",
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                      ...
                      >
                        ...
                        >
                          {t("Submit scans provided by administrators for AI analysis")}
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        >
                          {t("Wait 24-48 hours for results as they undergo thorough review")}
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        >
                          {t("Receive detailed analysis with professional verification")}
                        </Typography>
                      </Box>
                    </Box>
                  </Box>
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                      ...
                      >
                        ...
                        >
                          {t("Submit scans provided by administrators OR upload your own scans")}
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        >
                          {t("Receive instant AI analysis results without waiting")}
                        </Typography>
                      </Box>
                      ...
                      >
                        ...
                        >
                          {t("Access advanced analysis features and priority support")}
                        </Typography>
                      </Box>
                    </Box>
                  </Box>
            ...
            <Box sx={{ p: 4 }}>
              ...
              {scans.length === 0 ? (
                ...
                >
                  ...
                  >
                    <HealthAndSafetyIcon sx={{ color: "#ec4899", fontSize: 40, opacity: 0.8 }} />
                  </Box>
                  <Typography
                    variant="h5"
                    sx={{
                  ...
                  >
                    {t("You haven't submitted any scans for AI analysis yet. Click the button below to get started.")}
                  </Typography>
                  <Button
                    variant="contained"
                    startIcon={<AddIcon />}
      ...
      >
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
            <Box
              sx={{
                ...
                alignItems: "center",
                justifyContent: "center",
                boxShadow: "0 8px 16px rgba(0, 0, 0, 0.1), inset 0 0 0 1px rgba(255, 255, 255, 0.05)",
              }}
            >
        ...
        <DialogContent sx={{ p: 3 }}>
          {!isPatientPremium && (
            ...
            >
              {t("As a regular patient, your analysis results will be available within 24-48 hours.")}
            </Alert>
          )}
          ...
          {isPatientPremium && (
            ...
            >
              {t("As a premium patient, your analysis results will be available instantly.")}
            </Alert>
          )}
          ...
          {success && (
            ...
            >
              {isPatientPremium
                ? t("Scan submitted successfully! Your results will be available shortly.")
                : t("Scan submitted successfully! Your results will be available within 24-48 hours.")}
            </Alert>
          )}
        ...
        <DialogActions sx={{ p: 2.5 }}>
          ...
          <Button
            variant="contained"
            startIcon={isSubmitting ? <CircularProgress size={20} color="inherit" /> : <HealthAndSafetyIcon />}
                    ...
                    <Box sx={{ p: 3, flex: 1 }}>
                      <Grid container spacing={2}>
                        ...
                        <Grid item xs={12}>
                          ...
                          <Box sx={{ mb: 2 }}>
                            <Chip
                              icon={getStatusInfo(selectedResult.status || "Processing").icon}
                              label={t(selectedResult.status || "Processing")}
                              size="small"
                              sx={{
                                backgroundColor: getStatusInfo(selectedResult.status || "Processing").bgColor,
                                color: getStatusInfo(selectedResult.status || "Processing").color,
                                border: `1px solid ${getStatusInfo(selectedResult.status || "Processing").borderColor}`,
                                fontWeight: 600,
                                px: 0.5,
                              }}
                            />
                        ...
                        <Grid item xs={12}>
                          ...
                          {selectedResult.status === "Completed" ? (
                            ...
                            >
                              {selectedResult.finding || t("No abnormalities detected")}
                            </Typography>
                          ) : (
                            <Box
                              sx={{
                            ...
                            >
                              {isPatientPremium ? (
                                ...
                                <>
                                  <AccessTimeIcon sx={{ color: "#f59e0b", mb: 1 }} />
                                  <Typography
                                    variant="body2"
                                    sx={{
                                      color: "rgba(255, 255, 255, 0.7)",
                                  ...
                                  >
                                    {t("Results will be available within 24-48 hours")}
                                  </Typography>
                                </>
                              )}
                            </Box>
            ...
            <DialogActions sx={{ p: 2.5 }}>
              ...
              {selectedResult.reportUrl && (
                <Button
                  ...
                  onClick={() => handleDownload(BASE_URL, selectedResult.reportUrl)}
                  sx={{
                    borderRadius: "12px",
                    backgroundColor: "#d946ef",
                    color: "white",
