    ...
    >
      ...
      >
        ...
        >
          <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* Tech Lines */}
            <path d="M50,2 L50,15" stroke="#ec4899" strokeWidth="1" opacity="0.6">
              <animate attributeName="opacity" values="0.6;1;0.6" dur="2s" repeatCount="indefinite" />
            </path>
            <path d="M50,85 L50,98" stroke="#ec4899" strokeWidth="1" opacity="0.6">
              <animate attributeName="opacity" values="0.6;1;0.6" dur="2s" repeatCount="indefinite" />
            </path>
            <path d="M2,50 L15,50" stroke="#ec4899" strokeWidth="1" opacity="0.6">
              <animate attributeName="opacity" values="0.6;1;0.6" dur="2s" repeatCount="indefinite" />
            </path>
            <path d="M85,50 L98,50" stroke="#ec4899" strokeWidth="1" opacity="0.6">
              <animate attributeName="opacity" values="0.6;1;0.6" dur="2s" repeatCount="indefinite" />
            </path>
            ...
            {/* Scanning Line */}
            <line x1="20" y1="50" x2="80" y2="50" stroke="#ec4899" strokeWidth="1" opacity="0.8">
        ...
        >
          <span style={{ fontWeight: 600, color: "#ec4899" }}>Deep</span>Vision Lab
        </Typography>
      </Box>
      ...
      >
        ...
        <Grid container spacing={4}>
          ...
          {/* Nouvelle section: Informations de compte (simplifiée) */}
          <Grid item xs={12}>
            <Card
              sx={{
                borderRadius: "16px",
